<?php
    ...
    if (isset($_POST['firstname']) && !empty($_POST['firstname']) && isset($_POST['lastname']) && !empty($_POST['lastname'])) {
        ...
        $link = mysqli_connect('127.0.0.1', 'homestead', 'secret', 'crud_app');
        $updateSQL = "UPDATE users SET firstname='$firstname',lastname='$lastname' WHERE id='$user'";
...
<body>
    ...
    <div>
    <h1>Update user id : <?php echo $recs[0]['id'] ?></h1>
    <form class="needs-validation" action="" method="POST">
        <div class="form-row">
            <div class="col-md-6 mb-3">
            <label for="validationCustom01">First name</label>
            <input type="text" class="form-control" id="validationCustom01" value="<?php  echo $recs[0]['firstname'] ?>" name="firstname" required>
            ...
            <input type="text" class="form-control" id="validationCustom02" value="<?php  echo $recs[0]['lastname'] ?>" name="lastname" required>
            <div class="valid-feedback">
                Looks good!
            </div>
            </div>
